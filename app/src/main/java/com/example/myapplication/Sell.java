...
public class Sell extends AppCompatActivity {
    ...
    public void selll(View view) {
        quantity = qty.getText().toString();
        current = curr.getText().toString();
        BackgroundWorker9 backgroundWorker9 = new BackgroundWorker9(getApplicationContext());
        backgroundWorker9.execute("sell", userID, quantity, stockname, current);
        try {
            result = backgroundWorker9.get();
